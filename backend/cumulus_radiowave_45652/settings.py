"""
Django settings for cumulus_radiowave_45652 project.
...
ROOT_URLCONF = 'cumulus_radiowave_45652.urls'
...
WSGI_APPLICATION = 'cumulus_radiowave_45652.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cumulus_radiowave_45652 API",
    "DESCRIPTION": "API documentation for cumulus_radiowave_45652 App",
    "VERSION": "v1",
}
